...
final class ArrayUtil
{
    ...
    {
        Util::throwIfNotType(array('bool' => $strictKeyCheck));

        $projection = array();

        foreach ($input as $itemKey => $item) {
            Util::throwIfNotType(array('array' => array($item)));
    ...
    {
        Util::throwIfNotType(array('array' => $array));
    ...
    {
        Util::throwIfNotType(array('array' => $destination, 'string' => array($fieldName)));

        foreach ($items as $key => $item) {
            if (array_key_exists($key, $destination)) {
                Util::ensure(false, array_key_exists($fieldName, $destination[$key]));
