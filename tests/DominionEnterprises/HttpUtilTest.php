<?php
/**
 * Defines the HttpUtilTest class
 */

namespace DominionEnterprises\Tests;
use DominionEnterprises\HttpUtil as H;

/**
 * Defines unit tests for the \DominionEnterprises\HttpUtil class
 */
final class HttpUtilTest extends \PHPUnit_Framework_TestCase
{
    /**
     * @test
     * @group unit
     * @covers \DominionEnterprises\HttpUtil::parseHeaders
     */
     ...
     * @covers \DominionEnterprises\HttpUtil::parseHeaders
     */
    public function parseMalformedHeaders()
    {
        try {
            $headers = "&some\r\nbad+headers";
            $result = H::parseHeaders($headers);
     ...
     * @covers \DominionEnterprises\HttpUtil::parseHeaders
     */
    public function peclHttpFunctionality()
    {
        $headers = <<<EOT
HTTP/1.1 200 OK\r\n
...
EOT;
     ...
     * @covers \DominionEnterprises\HttpUtil::parseHeaders
     */
    public function methodAndUrlSet()
    {
        $headers = <<<EOT
...
EOT;
     ...
     * @test
     * @group unit
     * @covers \DominionEnterprises\HttpUtil::getQueryParams
     */
    public function multiParameters_normal()
    {
     ...
     * @covers \DominionEnterprises\HttpUtil::getQueryParams
     */
    public function multiParameters_emptyParameter()
    {
     ...
     * @covers \DominionEnterprises\HttpUtil::getQueryParams
     */
    public function multiParameters_garbage()
    {
